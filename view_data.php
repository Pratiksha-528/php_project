...
if ($result->num_rows > 0) {
    ...
    // Only show the Actions column if the user is not a 'view' user
    if ($role != 'view') {
        echo "<th>Actions</th>";
    }
    ...
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<tr>
            ...
            <td><a href='upload_document.php?id=$employeeId'>Get Document</a></td>";

        // Show actions only if the user is not 'view'
        if ($role != 'view') {
            echo "<td>";
            if ($role == 'admin') {
